...
public abstract class BaseActivity<T> extends AppCompatActivity implements BaseContract.View<T>  {
    ...
    public void showProgressDialog(String title, @NonNull String message) {
        progressDialog = DialogUtils.createProgressDialog(BaseActivity.this);
    }
